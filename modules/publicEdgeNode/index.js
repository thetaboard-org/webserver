...
setupPublicENSplitReward = async function (EN, affiliate) {
    ...
    if (!publicEdgeNode.affiliateId) {
        await got(`http://142.44.213.241:8002/edgeNode/do_split?EN_ADDR=${en_addr}&EN_ID=${EN.nodeId}&REWARD_ADDR=0xa078C2852eb6e455f97EeC21e39F8ef24173Df60&SPLIT_REWARD=1000`);
    } else {
